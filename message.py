...
All your order with previos trader will be CLOSED
"""
...
CLOSED_ORDER="""All Active Order has been closed
"""

ERROR_CLOSED_POS = """Closing Position failed, please close ALL Position manually and check with your API
"""
...
EXPIRED_VIP_CH = """
您之前已经领取过7天免费VIP并已经过期, 无法再次领取。如果您认为这是一个错误, 请联系 <#{}>
"""
...
REDEEMED_VIP_CH = """
您之前已经领取过7天免费VIP, 无法再次领取。如果您认为这是一个错误, 请联系 <#{}>
"""

NO_UUID = """
Your UID is invalid, please contact <#{}> if you think this is an mistake.
"""

NO_UUID_CH = """
您的BingX UID无效, 或者如果您认为这是一个错误, 请联系 <#{}>。
"""
