...
class ZonixDB():
    ...
    def get_all_player_status(self, player_id):
        sql = f"""SELECT a.player_id, a.api_key, a.api_secret, ifnull(t.trader_name, f.player_id), f.player_id as trader_discord_id, f.following_time, f.damage_cost, a.expiry_date
